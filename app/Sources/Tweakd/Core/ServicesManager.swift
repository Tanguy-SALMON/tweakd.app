...
enum ServiceKind: String, Sendable, CaseIterable {
    ...
    var icon: String {
        ...
        case .own:       return "slider.horizontal.3"
    ...
    /// Whether tweakd will let the user change this group at all.
...
final class ServicesManager: ObservableObject {
    ...
    nonisolated static func isReportable(_ label: String) -> Bool {
        ...
        // tracks for the session — Firefox, Zed, tweakd itself. Not a service,
    ...
    nonisolated static func classify(label: String, program: String) -> ServiceKind {
        ...
        if Brand.isOwnAgent(l) { return .own }
